...
const translations = {
  ro: {
    ...
    volleyTeamsRuleText: "Echipele sunt mixte. Pe teren joacă 6 persoane, cu cel puțin o fată în orice moment. Echipa trebuie să aibă minimum 6 jucători înscriși și pot exista rezerve.",
  ...
  es: {
    ...
    volleyTeamsRuleText: "Los equipos son mixtos. En el campo juegan 6 personas, con al menos una chica en todo momento. El equipo debe tener mínimo 6 jugadores inscritos y puede haber reservas.",
